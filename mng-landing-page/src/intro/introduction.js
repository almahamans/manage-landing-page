...
function Introduction(){
    return(
        <div className='grid grid-rows-1 grid-cols-10 place-items-center mt-9 mx-32 md:mx-16 lg:mx-16 sm:mx-5 sm:flex sm:flex-col-reverse sm:text-center xs:mx-5 xs:flex xs:flex-col-reverse xs:text-center'>
